...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val img:ImageView= findViewById(id.image_lemon_state)
        val msg:TextView = findViewById(id.text_action)
        when(lemonadeState)
        {
            SELECT-> msg.text="Click to select a lemon!"
            SQUEEZE->msg.text="Click to juice the lemon!"
            DRINK->msg.text="Click to drink your lemonade!"
            RESTART->msg.text="Click to start again!"
        }
        when(lemonadeState)
        {
            SELECT->img.setImageResource(drawable.lemon_tree)
            SQUEEZE->img.setImageResource(drawable.lemon_squeeze)
            DRINK->img.setImageResource(drawable.lemon_drink)
            RESTART->img.setImageResource(drawable.lemon_restart)
        }
    }
